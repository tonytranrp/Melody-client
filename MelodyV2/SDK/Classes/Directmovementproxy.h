...
public:
    ...
    virtual void setSlideOffset(Vec2<float> const&);
    ...
    virtual void setPosition(Vec3<float> const&);
    ...
    virtual Vec2<float> getRotation(void);
    virtual void setRotation(Vec2<float> const&);
    ...
    virtual Vec3<float> getLocalMoveVelocity(void);
    virtual void setLocalMoveVelocity(Vec3<float> const&);
    ...
    virtual void setCurrentLocalMoveVelocity(Vec2<float> const&);
    virtual void setLastPos(Vec3<float> const&);
    virtual int getLastPos(void);
    virtual void setLastDelta(Vec3<float> const&);
    ...
    virtual void _onMovePlayerPacketNormal(Vec3<float> const&, Vec2<float> const&, float);
